...
//     try{
//         const { total_harga, pembayaran, MenuId, AdminiD } = req.body;
//         const transaksi = await Transaksi.create({total_harga, pembayaran, MenuId: MenuId, AdminId: AdminiD});
//         res.status(200).json(transaksi);
//     }catch(error){
...
//         const { id } = req.params;
//         const { total_harga, pembayaran, MenuId, AdminId } = req.body;
//         const [updated] = await Transaksi.update({ total_harga, pembayaran, MenuId: MenuId, AdminId: AdminId }, { where: { id } });
